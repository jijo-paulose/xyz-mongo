...
/**
 * http://localhost:9080/xyz.mongo.ds.mvc.servlet.demo
 * /dis/
 * user!add!
 * /page/userAddResult.jsp
 * ?uName=1&psword=1&email=1&role=2&moduls=2&team=2
 * ftl
  *user!add!
  *page/userAddResult.ftl
  *?uName=1&psword=1&email=1&role=2&moduls=2&team=2
 */
...
public class MongoDataSourceImpl implements IMongoDataSource {
	...
	public Object col(String coll, String method, DBObject params)
		...
		if (checkargs) {
			...
			System.out.println("checkargs is--"+list);
			for (Object arg : list) {
	...
	public void setCollExecuters(Map<String, ICollectionExecuter> collExecuters) {
		System.err.println("collExecuters--"+collExecuters);
